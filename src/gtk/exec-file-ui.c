 ...
 * 
 * Purpose: LibFm's Open File Dialog in a C string, demoniac. :-P 
 * 
 * Joke: In a lifter there's a fireman, Santa Claus, an intelligent woman and a dog, the dog is killed.
 * Who killed the dog ?
 * 
 * It's the fireman, that's obvious, Santa Claus doesn't exist, an intelligent woman doesn't exist,
 * so it's the fireman.
 * 
 * :)
 * 
 **********************************************************************************************************************/
static const char exec_file_ui[] ="<?xml version='1.0'?>"
"<interface>"
