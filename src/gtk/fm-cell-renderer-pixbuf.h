...
GtkCellRenderer *   fm_cell_renderer_pixbuf_new         ();
GType               fm_cell_renderer_pixbuf_get_type    ();

void    fm_cell_renderer_pixbuf_render                  (GtkCellRenderer *cell, cairo_t *cr, GtkWidget *widget,
